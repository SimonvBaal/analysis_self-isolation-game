      ...
      for (n in 1:nSims) {
        ...
        for (round in 1:nRounds) {
          ...
          if (nInfections[round] < lockdownThreshold) {
            ...
            patientZeroSwitch <-
              append(patientZeroSwitch, 1) # To indicate that we are playing with a new patient zero after lockdown.
            
            # Copy infections from previous rounds.
            Infections$Infected[(1 + (round - 1) * 11):(11 + (round - 1) *
                                                          11)] <- Infections$Infected[(1 + (round - 2) * 11):(11 + (round - 2) * 11)]
