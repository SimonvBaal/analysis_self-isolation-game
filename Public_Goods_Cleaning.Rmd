...
exp1GameData <- 
  ...
  mutate(Order = factor(ifelse(subsession.round_number <= 20 & group.lockdown_cost == 60 | subsession.round_number > 20 & group.lockdown_cost == 90, "Low Cost First", "High Cost First")))
