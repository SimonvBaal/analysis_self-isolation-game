...
```{r Experiment 1 Analysis, silent = T}

#H1. Players’ incentivised self-isolation level is higher if the number of infections in the group is higher.
#H2. (i) Players’ incentivised self-isolation level is lower if their predictions of others’ degree of self-isolation are higher.
...
emtrends(H1and2aResults, "group.lockdown_cost", "subsession.round_number")


# H2. (ii) Players' hypothetical self-isolation level is lower for higher levels of others' self-isolation.
...
```{r Pilot Analysis, include = FALSE}
...
```{r Figures for visualisation, include = FALSE}
...
```{r P Game figures, include = FALSE}
...
```{r second player comparison, include = FALSE}
...
```{r Role splitting, include = FALSE}
