...
```{r Experiment 1 Analysis}
exp1GameData %>% group_by(gender) %>% summarise(contribution = mean(player.contribution))
exp1GameData %>% group_by(age) %>% summarise(contribution = mean(player.contribution), n = n())
